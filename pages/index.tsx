...
export default function Home() {
  const originalUsdcContract = "0x0FA8781a83E46826621b3BC094Ea2A0212e71B23"; //usdc token contract address
  const fundraiserManagerContract =
  "0xa15F65D141B538FDC50b9857720aCf23879b6089"; // goreli   
    ...
    return (
      <div className={styles.activefundraiserContainer}>
        <div>
          <div>
            ...
            <div style={{ display: "flex" }}>
              ...
              <p className={styles.hyperlinkText}>
                <Link
                  href={`https://mumbai.polygonscan.com/address/${fundraiser.fundraiserAddress}`}
                  target="_blank"
                >
                  {fundraiser.fundraiserAddress}
                </Link>
          ...
          <div>
            <h3 style={{ padding: "10px" , color: "black" }}>List of all Donors</h3>
            <table>
              <thead>
                <tr>
                  <th
    ...
    <>
      ...
      >
        <div className={styles.topPanel}>
          <div className={styles.walletAddress}>{`Go Fund Me Blockchain Version`}</div>
          <div className={styles.walletAddress}>
            {`Wallet Address: ${currentWalletAddress}`}
          </div>
          <div className={styles.walletAddress}>{`Wallet Balance: ${walletBalance} ETH`}</div>
